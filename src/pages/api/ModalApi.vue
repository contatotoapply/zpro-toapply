      ...
      <q-card-section>
        ...
        <div v-if="isWabaSelected" class="q-pa-md full-width q-mt-md">
          <q-banner class="bg-yellow text-black" inline-actions>
            <div class="text-h6">API Oficial (WABA)</div>
            <br>
            <p><b>Endpoints disponíveis</b>: SetQueue, SetTicketInfo, SetTag, ShowTicketInformation, ShowChannelInformation, ShowTicketInformationChatBot, ShowAllTicketInformation</p>
            <p><b>BETA:</b> SendMessageParams, SendMessageAPIFile, SendMessageAPIFileURL, SendMessageAPIText e SendMessageAPITextBase64</p>
            <p>Para envio de mensagens e demais componentes, usar a collection oficial da Meta: <a href="https://www.postman.com/meta/workspace/whatsapp-business-platform/collection/13382743-84d01ff8-4253-4720-b454-af661f36acc2" target="_blank">link </a></p>
          </q-banner>
        </div>
          ...
          <div class="row q-col-gutter-md">
            ...
            <div class="col-12 q-mt-md">
              <q-input square
                ...
                error-message="Token de autenticação é obrigatório" />
            </div>
          </div>
        </fieldset>
...
export default {
  ...
  computed: {
    ...
    cSessions () {
      return this.whatsapps.filter(w => (w.type === 'whatsapp' || w.type === 'waba' || w.type === 'baileys') && !w.isDeleted)
    },
    isWabaSelected () {
