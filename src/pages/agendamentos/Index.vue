  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'scheduleDate', label: 'Data', field: row => this.formatarData(row.scheduleDate), align: 'center' },
        { name: 'createdAt', label: 'Criada', field: row => this.formatarData(row.createdAt), align: 'center' },
