    ...
    <q-layout class="WAL__layout shadow-3" container view="lHr LpR lFr">
      ...
      <q-toolbar class="q-pr-none q-gutter-xs full-width" style="height: 64px">
        ...
        <q-toolbar v-show="toolbarSearch" class="row q-gutter-sm q-py-sm items-center">
            ...
            <q-menu content-class="shadow-10" square>
              <div class="row q-pa-sm" style="min-width: 350px; max-width: 350px;">
                <div class="q-ma-sm">
                  ...
                  <q-toggle
                    v-if="profile === 'admin' || profile === 'super'"
                    class="q-ml-lg"
          ...
          <q-btn flat class="bg-padrao btn-rounded" icon="mdi-phone-in-talk" @click="openWebphoneCall" style="flex: 1;">
            <q-tooltip content-class="bg-padrao text-grey-9 text-bold"> Abrir Wavoip </q-tooltip>
          </q-btn>
          ...
          <div class="q-pa-sm">
            ...
            <q-card class="bg-white btn-rounded q-mt-sm" style="width: 100%" bordered flat>
              <q-card-section class="text-center">
                <q-avatar style="border: 1px solid #9e9e9ea1 !important; width: 100px; height: 100px; cursor: pointer;" @click="showImageModal = true">
                  ...
                  <div class="contact-details">
                    ...
                    <div class="contact-item">
                      ...
                      <span class="contact-value">
                        <template v-if="ticketFocado.contact.number && !ticketFocado.contact.number.includes('nulo')">
                ...
                <q-btn flat class="btn-outline btn-small" style="margin-right: 4px;" label="Ligar" @click="outcomingCall(ticketFocado)" v-if="ticketFocado.whatsapp.wavoipToken" />
            ...
            <q-card class="bg-white q-mt-sm btn-rounded" style="width: 100%" bordered flat :key="`dialogflow-${ticketFocado.id}`"  v-if="dialogflowAtivo === 'enabled' && (ticketFocado.channel !== 'waba' && ticketFocado.channel !== 'telegram' && !ticketFocado.channel.includes('hub_') ) && !ticketFocado.isGroup">
              <q-card-section class="q-pa-none">
                <q-item tag="label" v-ripple>
                  <q-item-section>
            ...
            <q-card class="bg-white q-mt-sm btn-rounded" style="width: 100%" bordered flat :key="`n8n-${ticketFocado.id}`" v-if="n8nAtivo === 'enabled' && ticketFocado.channel !== 'telegram' && !ticketFocado.isGroup">
              <q-card-section class="q-pa-none">
                <q-item tag="label" v-ripple>
                  <q-item-section>
      ...
      <q-dialog v-model="showImageModal">
        <q-card>
          ...
          <q-card-actions align="right">
            <q-btn flat label="Fechar" color="primary" @click="showImageModal = false" />
          </q-card-actions>
        </q-card>
      </q-dialog>
...
export default {
  ...
  watch: {
    // 'pesquisaTickets.queuesIds': function(newVal) {
  ...
  methods: {
    ...
    async onLoadMore() {
      ...
      this.$q.notify({
        ...
        position: 'top',
        progress: true,
        message: 'Ao chegar ao final da lista de tickets, novos atendimentos são carregados em todas as abas, caso existam. Essa ação será recorrente a cada 3 segundos!',
        actions: [{
          icon: 'close',
          round: true,
          color: 'white'
