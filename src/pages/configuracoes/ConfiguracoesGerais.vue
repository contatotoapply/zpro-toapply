    ...
    <q-list class="text-weight-medium">
      <q-item tag="label" v-ripple>
        <q-item-section>
          ...
          <q-item-label caption> Somente o usuário responsável pelo ticket e/ou os administradores visualizarão o atendimento. </q-item-label>
        </q-item-section>
      ...
      <q-item tag="label" v-ripple>
        <q-item-section>
          <q-item-label>Visualizar Tickets sem Usuário ou Fila Atribuído (essa opção invalida os demais filtros e condições)</q-item-label>
          <q-item-label caption> Habilitando esta opção todos os usuários visualizaram os atendimentos que entrarem na plataforma. </q-item-label>
        </q-item-section>
      ...
      <q-item tag="label" v-ripple>
        <q-item-section>
          <q-item-label>Usar Envio Rápido de Mensagens (Beta)</q-item-label>
          <q-item-label caption> Habilitando esta opção, as mensagens serão enviadas de forma imediata, sem passar pelo sistema de envio cadenciado.</q-item-label>
        </q-item-section>
      ...
      <q-item tag="label" v-ripple>
        <q-item-section>
          ...
          <q-item-label caption> A API Não Oficial Baileys pode apresentar instabilidade no uso de grupos. Habilitando esta opção o sistema não abrirá ticket para grupos </q-item-label>
        </q-item-section>
      ...
      <q-item tag="label" v-ripple>
        <q-item-section>
          <q-item-label>Forçar usuário atual ao mudar status do atendimento pendente</q-item-label>
          <q-item-label caption> Habilitando esta opção, o ticket manterá o usuário associado ao atendimento quando mudar o status de aberto para pendente. </q-item-label>
        </q-item-section>
      ...
      <q-item tag="label" v-ripple>
        <q-item-section>
          <q-item-label>Mostrar histórico de mensagens</q-item-label>
          <q-item-label caption> Habilitando esta opção, o sistema irá mostrar todas as mensagens associadas ao canal e contato, em todos os tickets. </q-item-label>
        </q-item-section>
      ...
      <q-item tag="label" v-ripple>
        <q-item-section>
          <q-item-label>Não atualizar nome ao receber mensagens</q-item-label>
          <q-item-label caption> Habilitando esta opção, o sistema não irá atualizar o nome do contato em cada mensagem recebida. </q-item-label>
        </q-item-section>
      ...
      <!-- <q-item tag="label" v-ripple>
       ...
       <q-item tag="label" v-ripple>
        <q-item-section>
          <q-item-label>Enviar mensagens paradas</q-item-label>
          <q-item-label caption> Esse comando irá enviar mensagens paradas no sistema. </q-item-label>
          <!-- <div v-if="loading">Aguarde, tentando enviar mensagens...</div>
...
import { ListarTenantPorId, AlterarTenantShowChatbot, AlterarTenantNullTickets, AlterarTenantTentativas, AlterarTenantLimiteTickets, AlterarTenantAgruparTicket, AlterarTenantAtualizarNomes, AlterarTenantForcarPendente, AlterarTenantSemRedis, AlterarTenantFixarConexoes, AlterarTenantForcarAdmin } from 'src/service/tenants'
...
export default defineComponent({
  ...
  methods: {
    ...
    async forcarMensagem(){
      this.$q.dialog({
        title: 'Atenção!! Deseja realmente enviar todas as mensagens pendentes?',
        message: `Esse processo irá enviar todas as mensagens pendentes no sistema.`,
        cancel: {
          label: 'Não',
          color: 'primary',
          push: true
        ...
        try {
          ...
          if(key === 'ignoreGroupMsg'){
            this.$q.notify({
              position: 'top',
              type: 'negative',
              message: 'Atenção: A API Não Oficial Baileys pode apresentar instabilidades no uso de Grupos.',
              progress: true,
              actions: [{ icon: 'close', round: true, color: 'white' }],
            })
          }
