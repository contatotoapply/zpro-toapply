  ...
  <div v-if="userProfile === 'admin' || userProfile === 'super' ">
    <q-card-section>
      <q-banner class="bg-yellow text-black" inline-actions style="margin-left: 8px;margin-right: 8px;">
        Campanhas disponíveis para Baileys e Whatsapp-Web.JS</q-banner>
    </q-card-section>
    <q-table
      flat
      bordered
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'pendentesEnvio', label: 'Fila para Envio', field: 'pendentesEnvio', align: 'center' },
        // { name: 'pendentesEntrega', label: 'À Entregar', field: 'pendentesEntrega', align: 'center' },
        { name: 'recebidas', label: 'Enviadas', field: 'recebidas', align: 'center' },
