      ...
      <q-card class="q-pa-md"
        ...
        <q-card-section>
            ...
            <div class="col-12 section primary-gradient" v-if="whatsapp.type === 'baileys'">
              ...
              <div v-if="whatsapp.importMessages">
                ...
                <q-banner style="margin-top: 10px" class="bg-yellow text-black" inline-actions>
                  ...
                  <p>Esse evento só funciona na leitura do QRCode. Caso já tenha conectado, cria uma nova conexão com os dados da importação definidas e gere o novo qrcode.</p>
                  <p>Durante a importação desligue o chatbot interno e demais interações, e mantenha o horário de funcionamento aberto, pois toda mensagem que entrar no sistema, receberá irá interagir com essas configurações, caso estejam ativas.</p>
                </q-banner>
              </div>
            </div>
          ...
          <div class="row q-my-md">
            <div class="section primary-gradient col-12" v-if="chatgptAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram'  || whatsapp.type.includes('hub'))">
              <div class="text-h8" v-if="chatgptAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub')) " style="margin-top: 20px;">ChatGPT</div>
              <div class="col-12 " v-if="chatgptAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub')) ">
              ...
              <label v-if="chatgptAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub')) " class="text-caption">Após mudar o Prompt, o histórico do ChatGPT deve ser restaurado clicando no botão abaixo:</label>
              <q-btn round
                flat
                dense
                @click="limparGpts()"
                v-if="chatgptAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub')) "
                >
                <q-icon size="2em"
                  name="mdi-restore" />
                <q-tooltip>
              ...
              <label v-if="chatgptAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub')) " class="text-caption">Ao usar o Assistente o Prompt será desconsiderado</label>
              <q-btn round
                flat
                dense
            ...
            <div class="section primary-gradient col-12" v-if="typebotAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub'))">
              <div class="text-h8" v-if="typebotAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub')) " style="margin-top: 20px;">TypeBOT</div>
              <div class="col-12" v-if="typebotAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub'))">
              ...
              <div class="col-12" v-if="typebotAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub'))">
                <label class="text-caption">Mensagem para resposta inválida:</label>
                <input ref="inputAssistant"
                  class="q-pa-sm bg-white full-width"
                  placeholder="Digite a mensagem para opções inválidas "
                  dense
                  outlined
            ...
            <div class="section primary-gradient col-12" v-if="difyAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type.includes('hub'))">
              <div class="text-h8" v-if="difyAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type.includes('hub')) " style="margin-top: 20px;">Dify (Beta)</div>
              <div class="col-12" v-if="difyAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type.includes('hub'))">
                <label class="text-caption">API Key do Dify:</label>
                <input ref="inputAssistant"
                  class="q-pa-sm bg-white full-width blur-effect"
                  placeholder="Digite a Key do Dify"
                  dense
                  outlined
                  v-model="whatsapp.difyKey" />
              </div>
              <div class="col-12" v-if="difyAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type.includes('hub'))">
                <label class="text-caption">Url do Dify:</label>
                <input ref="inputAssistant"
                  class="q-pa-sm bg-white full-width blur-effect"
                  placeholder="Digite a Url do Dify"
                  dense
                  outlined
              ...
              <div class="col-12" v-if="difyAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type.includes('hub'))">
                ...
                <q-select ref="inputAssistant"
                  ...
                  :options="[
                    ...
                    { label: 'Fluxo', value: 'workflow' }
                  ]"
                  emit-value
                  map-options />
              </div>
              <div class="col-12" v-if="difyAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type.includes('hub'))">
                <label class="text-caption">Palavra para reiniciar o Dify:</label>
                <input ref="inputAssistant"
                  class="q-pa-sm bg-white full-width"
                  placeholder="Digite a Palavra para reiniciar o Dify"
                  dense
                  outlined
                  v-model="whatsapp.difyRestart" />
              </div>
              <div class="col-12" v-if="difyAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type.includes('hub'))">
                <label class="text-caption">Palavra para desligar o Dify:</label>
                <input ref="inputAssistant"
                  class="q-pa-sm bg-white full-width"
                  placeholder="Digite a Palavra para desligar o Dify"
                  dense
                  outlined
            ...
            <div class="section primary-gradient col-12" v-if="n8nAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type.includes('hub'))">
              <div class="text-h8" v-if="n8nAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type.includes('hub')) " style="margin-top: 20px;">N8N</div>
              <div class="col-12" v-if="n8nAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type.includes('hub')) ">
            ...
            <div class="section primary-gradient" v-if="dialogflowAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys')">
              <div class="text-h8" v-if="dialogflowAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys') " style="margin-top: 20px;">DialogFlow</div>
            ...
            <div class="section primary-gradient" v-if="whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type.includes('hub')">
            ...
            <div class="section primary-gradient" v-if="whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type.includes('hub')">
            <div >
              <div class="col-12" v-if="whatsapp.type === 'whatsapp' || whatsapp.type === 'waba' || whatsapp.type === 'baileys' || whatsapp.type.includes('hub')">
                <q-item tag="label" v-ripple>
                  <q-item-section>
            ...
            <div>
              <div class="col-12" v-if="whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type.includes('hub')">
                <q-item tag="label" v-ripple>
                  <q-item-section>
                    <q-item-label>Habilitar transcrição de áudio</q-item-label>
                    <q-item-label caption> Habilitando esta opção os áudios recebidos serão transcritos. </q-item-label>
                  </q-item-section>
            ...
            <div class="col-12" v-if="whatsapp.transcribeAudio === 'enabled'">
              <q-item tag="label" v-ripple>
                <q-item-section>
                  <q-item-label>Configuração de Transcrição de Áudio (JSON)</q-item-label>
                  <q-item-label caption>Insira as configurações em formato JSON para o Google Speech-To-Text.</q-item-label>
                </q-item-section>
            ...
            <div class="col-12" v-if="whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys'">
              <q-item tag="label" v-ripple>
                <q-item-section>
                  <q-item-label>Habilitar destruição de mensagem</q-item-label>
                  <q-item-label caption> Habilitando esta opção mensagens removidas serão destruídas do sistema. </q-item-label>
                </q-item-section>
            ...
            <div>
              <div class="col-12" v-if="whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys'">
                <q-item tag="label" v-ripple>
                  <q-item-section>
                    <q-item-label>Habilitar envio de mensagem para aniversariantes</q-item-label>
                    <q-item-label caption> Habilitando esta opção no dia do aniversário do contato, será enviada a mensagem definida no campo abaixo. </q-item-label>
                  </q-item-section>
            ...
            <div class="col-12" v-if="whatsapp.birthdayDate === 'enabled'">
              <div class="text-h8" style="margin-top: 20px;">Mensagem</div>
              <div class="col-12">
                <label class="text-caption">Mensagem de Aniversário:</label>
          ...
          <div class="section primary-gradient col-12" v-if="((whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'instagram') && whatsapp.status !== 'CONNECTED')">
            <div class="text-h8" style="margin-top: 20px;" v-if="((whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'instagram') && whatsapp.status !== 'CONNECTED')">Camadas adicionais para serviços não oficiais</div>
