    ...
    <div class="q-my-md">
      ...
      >
        ...
        <q-banner style="margin-top: 10px" class="bg-yellow text-black" inline-actions>
          <p>Essa função está disponível para Baileys e Whatsapp-Web.JS</p>
        </q-banner>
        <q-list class="text-weight-medium">
          ...
          <div class="row q-px-md">
            ...
            <div v-if="media && whatsappId?.type !== 'baileys'" class="col-12 q-py-md" style="margin: 1px;">
            ...
            <div class="col-12">
              <q-btn label="Enviar" :disable="loading" @click="enviar" color="primary" style="margin-bottom: 15px;margin-right: 5px;"/>
