    ...
    <q-card class="q-pa-md">
      ...
      <q-card-section class="row q-col-gutter-md">
        ...
        <c-input
          ...
          hint="Número do CPF/CNPJ deverá conter caracteres especiais como traços e barras."
          v-model="contato.cpf"
          label="CPF/CNPJ"
        />
        <c-input
          ...
          hint="A data de aniversário deverá ser informada no formato 01/01/1990."
        />
        <c-input
          class="col-4"
          outlined
      ...
      <q-card-actions align="right" class="q-mt-lg">
        <q-btn label="Sair" color="negative" v-close-popup class="q-px-md" />
        <q-btn class="q-ml-lg q-px-md" label="Salvar" color="primary" @click="saveContact" />
      </q-card-actions>
    </q-card>
  </q-dialog>
</template>
